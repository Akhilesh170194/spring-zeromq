...
//                    if (t == null) {
//                        sendResponse("Message Received and processed successfully.", socket);
//                    }
//                    else {
//                        sendResponse("Message Received but failed to process.", socket);
//                    }
//                });
//            }
//        }
...
//    }
//
//    private void sendResponse(String message, ZMQ.Socket socket) {
//        try {
